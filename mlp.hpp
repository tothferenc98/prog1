 ...
 *
 * @file ql.hpp
 * @author  Norbert Btfai <nbatfai@gmail.com>
 * @version 0.0.1
 *
 * @section LICENSE
 *
 * Copyright (C) 2015 Norbert Btfai, batfai.norbert@inf.unideb.hu
 *
 ...
 * developmental robotic agent called Samu Btfai". It is our hope
